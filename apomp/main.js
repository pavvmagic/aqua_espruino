...
function start(){
  ...
  iEspTO=3000;
  lcdO={};
  lcdO.ver="JS:"+process.version+" 3.8/"+cfg.ver;
  ...
  wValOld=0;
  kbdSt=0;
  udsTm=0; udsVal=0; udsAv=0.0013; udsAvS=udsAv*2; udsThr=0.0017; udsLowThr=0.0019; udsRate=0.000012;
